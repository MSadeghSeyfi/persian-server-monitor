...
هر روز صبح یک خلاصه کامل از وضعیت سرور دریافت می‌کنید — منابع، سرویس‌ها، سایت‌ها و وضعیت امنیتی، همه در یک پیام:

<img src="screenshots/daily-report.png" width="320">
